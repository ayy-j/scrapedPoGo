...
- Generated: 2026-02-21T03:41:04.831Z
- Mode: report
...
- [doc-schema-block] Embedded doc JSON schema differs from canonical schema (3 difference(s)). (events | dataDocumentation/Events.md | /items/properties/pokemon/items/properties/altText)
- [doc-schema-block] Embedded doc JSON schema differs from canonical schema (1 difference(s)). (raids | dataDocumentation/Raids.md | /items/properties/altText)
- [doc-schema-block] Embedded doc JSON schema differs from canonical schema (1 difference(s)). (research | dataDocumentation/Research.md | /items/properties/rewards/items/properties/altText)
- [doc-schema-block] Embedded doc JSON schema differs from canonical schema (1 difference(s)). (rocketLineups | dataDocumentation/RocketLineups.md | /definitions/shadowPokemon/properties/altText)
...
- [coverage-data] Data file is not mapped to a canonical schema/data/doc triplet: data/eventTypes/research.min.json (data/eventTypes/research.min.json)
...
- [doc-field-table] Field "bonus" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "bonus" not found while resolving "bonus".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "bonusDisclaimers" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "bonusDisclaimers" not found while resolving "bonusDisclaimers".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "lureModuleBonus" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "lureModuleBonus" not found while resolving "lureModuleBonus".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "exclusiveBonuses" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "exclusiveBonuses" not found while resolving "exclusiveBonuses".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "raidAlternation" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "raidAlternation" not found while resolving "raidAlternation".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "raidFeaturedAttacks" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "raidFeaturedAttacks" not found while resolving "raidFeaturedAttacks".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "research.field" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "field" not found while resolving "research.field".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "research.special" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "special" not found while resolving "research.special".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "research.timed" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "timed" not found while resolving "research.timed".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "research.masterwork" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "masterwork" not found while resolving "research.masterwork".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "research.breakthrough" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "breakthrough" not found while resolving "research.breakthrough".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "battle" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "battle" not found while resolving "battle".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "battle.leagues" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "battle" not found while resolving "battle.leagues".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "battle.featuredAttack" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "battle" not found while resolving "battle.featuredAttack".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "rocket" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "rocket" not found while resolving "rocket".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "rocket.shadows" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "rocket" not found while resolving "rocket.shadows".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "rocket.leaders" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "rocket" not found while resolving "rocket.leaders".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "rocket.giovanni" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "rocket" not found while resolving "rocket.giovanni".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "rocket.grunts" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "rocket" not found while resolving "rocket.grunts".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "shinyDebuts" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "shinyDebuts" not found while resolving "shinyDebuts".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "rewards" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "rewards" not found while resolving "rewards".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "rewards.ticketedResearch" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "rewards" not found while resolving "rewards.ticketedResearch".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "rewards.ticketBonuses" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "rewards" not found while resolving "rewards.ticketBonuses".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "rewards.ticketPrice" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "rewards" not found while resolving "rewards.ticketPrice".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "rewards.ticketAddOns" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "rewards" not found while resolving "rewards.ticketAddOns".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "showcases" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "showcases" not found while resolving "showcases".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "photobomb" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "photobomb" not found while resolving "photobomb".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "photobomb.description" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "photobomb" not found while resolving "photobomb.description".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "photobomb.pokemon" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "photobomb" not found while resolving "photobomb.pokemon".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "communityDays" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "communityDays" not found while resolving "communityDays".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "features" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "features" not found while resolving "features".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "goBattleLeague" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "goBattleLeague" not found while resolving "goBattleLeague".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "goPass" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "goPass" not found while resolving "goPass".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "pricing" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "pricing" not found while resolving "pricing".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "pointTasks" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "pointTasks" not found while resolving "pointTasks".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "ranks" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "ranks" not found while resolving "ranks".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "featuredPokemon" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "featuredPokemon" not found while resolving "featuredPokemon".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "milestoneBonuses" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "milestoneBonuses" not found while resolving "milestoneBonuses".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "eventInfo" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "eventInfo" not found while resolving "eventInfo".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "habitats" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "habitats" not found while resolving "habitats".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "whatsNew" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "whatsNew" not found while resolving "whatsNew".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "sales" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "sales" not found while resolving "sales".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "maxBattles" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "maxBattles" not found while resolving "maxBattles".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "maxMondays" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "maxMondays" not found while resolving "maxMondays".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "canBeShiny" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "canBeShiny" not found while resolving "canBeShiny".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "description" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "description" not found while resolving "description".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "customSections" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "customSections" not found while resolving "customSections".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "availability" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "availability" not found while resolving "availability".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "encounters" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "encounters" not found while resolving "encounters".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "isPaid" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "isPaid" not found while resolving "isPaid".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "price" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "price" not found while resolving "price".). (events | dataDocumentation/Events.md)
- [doc-field-table] Field "tasks" is not explicitly defined in canonical schema but allowed by additionalProperties (Field "tasks" not found while resolving "tasks".). (events | dataDocumentation/Events.md)
...
- data: data/eventTypes/research.min.json
