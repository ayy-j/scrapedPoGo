...
⚠️ Server uploads are limited to 4.5 MB, if you need more than that, see the [client uploads](https://vercel.com/docs/storage/vercel-blob/client-upload) quickstart.
